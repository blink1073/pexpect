...
def nonempty_lines(res):
    return [l for l in res.splitlines() if l]
...
class REPLWrapTestCase(unittest.TestCase):
    ...
    @pytest.mark.skipif(os.name=='nt', reason='man not available on Windows')
    ...
    def test_long_running_multiline(self):
        ...
        self.assertEqual(nonempty_lines(res), ['begin', 'done'])
    ...
    def test_multiline(self):
        ...
        self.assertEqual(nonempty_lines(res), ['1 2', '3 4'])
    ...
    def test_python(self):
        ...
        assert nonempty_lines(res) == ['0', '1', '2']
